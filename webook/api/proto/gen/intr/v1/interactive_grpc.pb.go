...
const (
	...
	InteractiveService_GetTopNLikedArticles_FullMethodName = "/intr.v1.InteractiveService/GetTopNLikedArticles"
)
...
type InteractiveServiceClient interface {
	...
	GetTopNLikedArticles(ctx context.Context, in *GetTopNLikedArticlesRequest, opts ...grpc.CallOption) (*GetTopNLikedArticlesResponse, error)
}
...
func (c *interactiveServiceClient) GetTopNLikedArticles(ctx context.Context, in *GetTopNLikedArticlesRequest, opts ...grpc.CallOption) (*GetTopNLikedArticlesResponse, error) {
	out := new(GetTopNLikedArticlesResponse)
	err := c.cc.Invoke(ctx, InteractiveService_GetTopNLikedArticles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InteractiveServiceServer interface {
	...
	GetTopNLikedArticles(context.Context, *GetTopNLikedArticlesRequest) (*GetTopNLikedArticlesResponse, error)
...
func (UnimplementedInteractiveServiceServer) GetTopNLikedArticles(context.Context, *GetTopNLikedArticlesRequest) (*GetTopNLikedArticlesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTopNLikedArticles not implemented")
}
...
func _InteractiveService_GetTopNLikedArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTopNLikedArticlesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).GetTopNLikedArticles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_GetTopNLikedArticles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).GetTopNLikedArticles(ctx, req.(*GetTopNLikedArticlesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InteractiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTopNLikedArticles",
			Handler:    _InteractiveService_GetTopNLikedArticles_Handler,
		},
	},
